...
export const WebhooksApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createWebhook: async (webhookRequest: WebhookRequest, acceptLanguage?: CreateWebhookAcceptLanguageEnum, xChildCompanyId?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getWebhooks: async (webhookRequest: WebhookRequest, acceptLanguage?: GetWebhooksAcceptLanguageEnum, xChildCompanyId?: string, limit?: number, search?: string, url?: string, next?: string, previous?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'webhookRequest' is not null or undefined
            assertParamExists('getWebhooks', 'webhookRequest', webhookRequest)
            const localVarPath = `/webhooks`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const WebhooksApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createWebhook(webhookRequest: WebhookRequest, acceptLanguage?: CreateWebhookAcceptLanguageEnum, xChildCompanyId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebhookResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createWebhook(webhookRequest, acceptLanguage, xChildCompanyId, options);
         ...
         * @throws {RequiredError}
         */
        async getWebhooks(webhookRequest: WebhookRequest, acceptLanguage?: GetWebhooksAcceptLanguageEnum, xChildCompanyId?: string, limit?: number, search?: string, url?: string, next?: string, previous?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetWebhooksResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getWebhooks(webhookRequest, acceptLanguage, xChildCompanyId, limit, search, url, next, previous, options);
            const index = configuration?.serverIndex ?? 0;
...
export const WebhooksApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createWebhook(webhookRequest: WebhookRequest, acceptLanguage?: CreateWebhookAcceptLanguageEnum, xChildCompanyId?: string, options?: any): AxiosPromise<WebhookResponse> {
            return localVarFp.createWebhook(webhookRequest, acceptLanguage, xChildCompanyId, options).then((request) => request(axios, basePath));
        },
        /**
         * Deletes a webhook.
         * @summary Delete webhook
         ...
         * @throws {RequiredError}
         */
        getWebhooks(webhookRequest: WebhookRequest, acceptLanguage?: GetWebhooksAcceptLanguageEnum, xChildCompanyId?: string, limit?: number, search?: string, url?: string, next?: string, previous?: string, options?: any): AxiosPromise<GetWebhooksResponse> {
            return localVarFp.getWebhooks(webhookRequest, acceptLanguage, xChildCompanyId, limit, search, url, next, previous, options).then((request) => request(axios, basePath));
        },
        /**
         * Sends a test event to the specified webhook to verify it can receive events.
         * @summary Test webhook
...
export interface WebhooksApiInterface {
     ...
     */
    createWebhook(webhookRequest: WebhookRequest, acceptLanguage?: CreateWebhookAcceptLanguageEnum, xChildCompanyId?: string, options?: RawAxiosRequestConfig): AxiosPromise<WebhookResponse>;
     ...
     * @memberof WebhooksApiInterface
     */
    getWebhooks(webhookRequest: WebhookRequest, acceptLanguage?: GetWebhooksAcceptLanguageEnum, xChildCompanyId?: string, limit?: number, search?: string, url?: string, next?: string, previous?: string, options?: RawAxiosRequestConfig): AxiosPromise<GetWebhooksResponse>;
...
export class WebhooksApi extends BaseAPI implements WebhooksApiInterface {
     ...
     */
    public createWebhook(webhookRequest: WebhookRequest, acceptLanguage?: CreateWebhookAcceptLanguageEnum, xChildCompanyId?: string, options?: RawAxiosRequestConfig) {
        return WebhooksApiFp(this.configuration).createWebhook(webhookRequest, acceptLanguage, xChildCompanyId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof WebhooksApi
     */
    public getWebhooks(webhookRequest: WebhookRequest, acceptLanguage?: GetWebhooksAcceptLanguageEnum, xChildCompanyId?: string, limit?: number, search?: string, url?: string, next?: string, previous?: string, options?: RawAxiosRequestConfig) {
        return WebhooksApiFp(this.configuration).getWebhooks(webhookRequest, acceptLanguage, xChildCompanyId, limit, search, url, next, previous, options).then((request) => request(this.axios, this.basePath));
    }
