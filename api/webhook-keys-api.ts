...
export const WebhookKeysApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createWebhookKey: async (acceptLanguage?: CreateWebhookKeyAcceptLanguageEnum, xChildCompanyId?: string, webhookKeyRequest?: WebhookKeyRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
        ...
        updateWebhookKey: async (id: string, acceptLanguage?: UpdateWebhookKeyAcceptLanguageEnum, webhookKeyUpdateRequest?: WebhookKeyUpdateRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            localVarHeaderParameter['Content-Type'] = 'application/vnd.app-v2.2.0+json';
...
export const WebhookKeysApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createWebhookKey(acceptLanguage?: CreateWebhookKeyAcceptLanguageEnum, xChildCompanyId?: string, webhookKeyRequest?: WebhookKeyRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WebhookKeyCreateResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createWebhookKey(acceptLanguage, xChildCompanyId, webhookKeyRequest, options);
...
export const WebhookKeysApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createWebhookKey(acceptLanguage?: CreateWebhookKeyAcceptLanguageEnum, xChildCompanyId?: string, webhookKeyRequest?: WebhookKeyRequest, options?: any): AxiosPromise<WebhookKeyCreateResponse> {
            return localVarFp.createWebhookKey(acceptLanguage, xChildCompanyId, webhookKeyRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * Deletes a webhook signing key.
         * @summary Delete webhook key
...
export interface WebhookKeysApiInterface {
     ...
     */
    createWebhookKey(acceptLanguage?: CreateWebhookKeyAcceptLanguageEnum, xChildCompanyId?: string, webhookKeyRequest?: WebhookKeyRequest, options?: RawAxiosRequestConfig): AxiosPromise<WebhookKeyCreateResponse>;
...
export class WebhookKeysApi extends BaseAPI implements WebhookKeysApiInterface {
     ...
     */
    public createWebhookKey(acceptLanguage?: CreateWebhookKeyAcceptLanguageEnum, xChildCompanyId?: string, webhookKeyRequest?: WebhookKeyRequest, options?: RawAxiosRequestConfig) {
        return WebhookKeysApiFp(this.configuration).createWebhookKey(acceptLanguage, xChildCompanyId, webhookKeyRequest, options).then((request) => request(this.axios, this.basePath));
    }
